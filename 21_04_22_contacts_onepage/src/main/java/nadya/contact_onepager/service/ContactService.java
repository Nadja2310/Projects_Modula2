...
public class ContactService {
    ...
    public List<Contact> getSearchContacts(String searchPattern) {
        List<Contact> contacts=contactRepo.findAllByNameContainingIgnoreCaseOrLastNameContainingIgnoreCase(searchPattern,searchPattern);
        return contacts;
    }
}
